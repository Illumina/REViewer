...
public:
    RepeatAlignmentStats(
        const graphtools::GraphAlignment& canonical_alignment, AlignmentType canonical_alignment_type,
    ...
    const graphtools::GraphAlignment& canonicalAlignment() const { return canonical_alignment_; }
...
private:
    graphtools::GraphAlignment canonical_alignment_;
